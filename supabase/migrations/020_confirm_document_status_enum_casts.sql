-- ============================================================
-- 020 — confirm_document_and_create_records usa enums reales
--
-- Fix:
--   - Evita errores al insertar TEXT en columnas enum
--     prescriptions.status y medical_tests.status
--   - Tipa las variables internas con los enums reales del schema
-- ============================================================
